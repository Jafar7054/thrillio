...
<script>
    function validateForm() {
        var title = document.forms["addmovieform"]["title"].value.trim();
        var genre = document.forms["addmovieform"]["genre"].value.trim();
        var url = document.forms["addmovieform"]["url"].value.trim();
...
<body>
	<div class="content">
	       ...
	       <br><br>
		   <center>
	<form name="addmovieform" method="POST" action="<%=request.getContextPath()%>/addMovie" onsubmit="return validateForm()">
      <fieldset>
	 <u style="color:#DB5227"><b><legend style="font-family:garamond;font-size:34px;margin:0 0 0 10px;color:#DB5227;text-decoration: none;">New Movie</legend>	    
	    </b></u><table>
			<tr>
			...
			<tr>
			    <td><label style="font-family:garamond;font-size:30px;margin:0 0 0 10px;color:#DB5227;text-decoration: none;">Book Genre:<span class="required">*</span></label></td>
			    <td>
        	...
        	<tr>
        		<td>&nbsp;</td>
        		<td><input type="submit" name="submitMovie" value="Add Movie"></td>
