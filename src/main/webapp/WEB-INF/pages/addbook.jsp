...
<script>
    function validateForm() {
        ...
        var genre = document.forms["addbookform"]["genre"].value.trim();
        var url = document.forms["addbookform"]["url"].value.trim();
...
<body>
	<div class="content">
	       ...
	       <br><br>
		   <center>
	<form name="addbookform" method="POST" action="<%=request.getContextPath()%>/addBook" onsubmit="return validateForm()">
      <fieldset>
	 <u style="color:#DB5227"><b><legend style="font-family:garamond;font-size:34px;margin:0 0 0 10px;color:#DB5227;text-decoration: none;">New Book</legend>	    
	    </b></u><table>
			<tr>
        	...
        	<tr>
        		<td>&nbsp;</td>
        		<td><input type="submit" name="submitBook" value="Add Book"></td>
